...
<jsp:useBean id="nameOrden" type="ArrayList<com.example.lab8iweb.DTOs.EstadisticasLeaderSheep>" scope="request"/>
...
<main class="table">
    ...
    <section class="table__body">
        <table>
            ...
            <tbody>
            <%
                if (nameOrden != null && !nameOrden.isEmpty()) {

                    for (EstadisticasLeaderSheep u : nameOrden) {
            %>
            <tr>
