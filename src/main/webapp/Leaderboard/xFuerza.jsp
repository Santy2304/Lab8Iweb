...
<jsp:useBean id="FuerzaOrden" type="ArrayList<com.example.lab8iweb.DTOs.EstadisticasLeaderSheep>" scope="request"/>
...
<main class="table">
    ...
    <section class="table__body">
        <table>
            ...
            <tbody>
            <%
                if (FuerzaOrden != null && !FuerzaOrden.isEmpty()) {

                    for (EstadisticasLeaderSheep u : FuerzaOrden) {
            %>
            <tr>
