...
<jsp:useBean id="moralOrden" type="ArrayList<com.example.lab8iweb.DTOs.EstadisticasLeaderSheep>" scope="request"/>
...
<main class="table">
    ...
    <section class="table__body">
        <table>
            ...
            <tbody>
            <%
                if (moralOrden != null && !moralOrden.isEmpty()) {

                    for (EstadisticasLeaderSheep u : moralOrden) {
            %>
            <tr>
