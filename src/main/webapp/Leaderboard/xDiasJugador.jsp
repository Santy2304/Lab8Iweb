...
<jsp:useBean id="diasJugadorOrden" type="ArrayList<com.example.lab8iweb.DTOs.EstadisticasLeaderSheep>" scope="request"/>
...
<main class="table">
  ...
  <section class="table__body">
    <table>
      ...
      <tbody>
      <%
        if (diasJugadorOrden != null && !diasJugadorOrden.isEmpty()) {

          for (EstadisticasLeaderSheep u : diasJugadorOrden) {
      %>
      <tr>
